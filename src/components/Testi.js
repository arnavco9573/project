    ...
    useEffect(() => {
        setItems([
          ...
          },
          {
            ...
            content: <>
            <p>"Adrian has helped me several times on my Javascript and React
          ...
          },
          {
            ...
            content: 
            <>
            <p>Adrian and this team are always there to help and guide you. Being
            ...
            very fortunate to be a part of this program.</p></>
          },
          {
            id: 4,
            img:kristian,
            ...
            content:<>
            <p>Simply the best way to take your development skills to the next
          ...
          },
          {
            ...
            content: <><p>Adrian, I wanted to thank you for your React courses. I've
          ...
          },
          {
            ...
            content:<><p>JS Mastery has been precisely what I was looking for. I have
